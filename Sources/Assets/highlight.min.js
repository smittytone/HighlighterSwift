...
contains:[O]},M=(e,n,t={})=>{const a=r({scope:"comment",begin:e,end:n,
...
i.__beforeBegin=null,[I,B,$].forEach((e=>e(i,s))),i.isCompiled=!0;let l=null
...
;t+=S.substr(e),M.addText(t)}function g(){null!=k.subLanguage?(()=>{
...
;C=e.index+t}return y(n.substr(C)),M.closeAllNodes(),M.finalize(),O=M.toHTML(),{
...
}function v(e){return e=(e||"").toLowerCase(),t[e]||t[i[e]]}
...
match:m(/`/,Le,/`/)},k=[O,{className:"variable",match:/\$\d+/},{
...
className:"meta",match:m(/@/,Le)}],M={match:g(/\b[A-Z]/),relevance:0,contains:[{
className:"type",
...
begin:p(g(m(Le,/\s*:/)),g(m(Le,/\s+/,Le,/\s*:/))),end:/:/,relevance:0,
contains:[{className:"keyword",match:/\b_\b/},{className:"params",match:Le}]
},...a,...c,...b,h,v,...x,M,A],endsParent:!0,illegal:/["']/},R={
match:[/func/,/\s+/,p(O.match,Le,De)],className:{1:"keyword",3:"title.function"
},contains:[C,T,n],illegal:[/\[/,/%/]},D={
match:[/\b(?:subscript|init[?!]?)/,/\s*(?=[<(])/],className:{1:"keyword"},
contains:[C,T,n],illegal:/\[|%/},I={match:[/operator/,/\s+/,De],className:{
1:"keyword",3:"title"}},B={begin:[/precedencegroup/,/\s+/,$e],className:{
...
aliases:["yml"],contains:l}},grmr_coffeescript:e=>{const n={
keyword:me.concat(["then","unless","until","loop","by","when","and","or","is","isnt","not"]).filter((t=["var","const","let","function","static"],
e=>!t.includes(e))),literal:pe.concat(["yes","no","on","off"]),
...
end:/\)/,keywords:n,contains:["self"].concat(r)}]},c={variants:[{
...
returnBegin:!0,returnEnd:!0,relevance:0}]}}});const je=ne
;for(const e of Object.keys(Ue)){const n=e.replace("grmr_","").replace("_","-")
;je.registerLanguage(n,Ue[e])}return je}()
